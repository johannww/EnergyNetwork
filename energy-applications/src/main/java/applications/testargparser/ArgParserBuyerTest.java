...
public class ArgParserBuyerTest {

    protected CommandLine cmd;
    protected Options options;

    public ArgParserBuyerTest() {
        options = new Options();
    }
    ...
    public CommandLine parseArgs(String[] args) throws Exception {
        ...
        Option buyerQuantity = new Option("buyers", "buyers", true,
        ...
        Option utilityUrl = new Option("utilityurl", "utilityurl", true,
        "URL for interacting with the Utility Company!");
        utilityUrl.setRequired(true);
        options.addOption(utilityUrl);
        ...
        try {
            ...
            formatter.printHelp("BuyerForTest.jar", header, options, "");
            System.exit(1);
        }
